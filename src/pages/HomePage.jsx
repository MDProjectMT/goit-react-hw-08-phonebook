...
import manWork from '../images/man-work.jpg';
...
const styles = {
  ...
  container3: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    border: '0.2px solid #c2b698',
    borderRadius: '4px',
    background: 'linear-gradient(to right, #efefe3, #c2b698)',
        ...
        <div style={styles.container3}>
          ...
          <div>
            ...
            <p style={styles.list}>
              ...
              intuitive <b>Contacts Manager</b>. Whether you're managing
              personal connections, professional networks, or both, our app is
              designed to make your life easier. Our <b>Contacts Manager </b>
              offers a seamless experience, allowing you to store, view, and
              manage all your contacts in one convenient place. No more
              scattered information or lost phone numbers - everything you need
